...
def courseDetails(driver,course_list,course_list_size,count,course_name,course_group_id,search_keywords):
    ...
    certification=1
    print(course_group_id,name,search_keywords,description,'udemy',course_specific_url,1,rating,rating_count,student_count,last_updated,"ENG",price,count,accessibility,devices,certification,date,date)
    course_id=db.insertCourseData(course_group_id,name,search_keywords,description,'udemy',course_specific_url,1,rating,rating_count,student_count,last_updated,"ENG",price,count,accessibility,devices,certification,date,date)
...
for course_name_list in course_file:
    ...
    course(driver,course_name,2,course_group_id,search_keywords)
